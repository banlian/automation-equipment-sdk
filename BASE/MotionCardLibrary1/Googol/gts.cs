...
namespace LMotionCardLib.LDriver.Googol
{
    public class mc
    {
        ...
        [DllImport("gts.dll")]
        public static extern short GT_CrdData(short cardNum, short crd,ref TCrdData pCrdData,short fifo);
        [DllImport("gts.dll")]
        ...
        [DllImport("gts.dll")]
        public static extern short GT_GetPrfMode(short cardNum, short axis, out short pMode);
        [DllImport("gts.dll")]
        ...
        [DllImport("gts.dll")]
        public static extern short GT_LoadExtConfig(short cardNum, string fileName);
        [DllImport("gts.dll")]
        public static extern short GT_SetExtIoValue(short cardNum, short mdl, ushort value);
        [DllImport("gts.dll")]
        public static extern short GT_GetExtIoValue(short cardNum, short mdl, ref ushort value);
        [DllImport("gts.dll")]
        public static extern short GT_SetExtIoBit(short cardNum, short mdl, short index, ushort value);
        [DllImport("gts.dll")]
        public static extern short GT_GetExtIoBit(short cardNum, short mdl, short index, ref ushort value);
        [DllImport("gts.dll")]
        public static extern short GT_GetExtAdValue(short cardNum, short mdl, short chn, ref ushort value);
        [DllImport("gts.dll")]
        public static extern short GT_GetExtAdVoltage(short cardNum, short mdl, short chn, ref double value);
        [DllImport("gts.dll")]
        ...
        [DllImport("gts.dll")]
        public static extern short GT_GetStsExtMdl(short cardNum, short mdl, short chn, ref ushort value);
        [DllImport("gts.dll")]
        public static extern short GT_GetExtDoValue(short cardNum, short mdl, ref ushort value);
        [DllImport("gts.dll")]
        public static extern short GT_GetExtMdlMode(short cardNum, ref short pMode);
        [DllImport("gts.dll")]
